package edu.uw.tcss450.varpar.weatherapp.services;
...
import edu.uw.tcss450.varpar.weatherapp.AuthActivity;
...
public class PushReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        int chatId = -1;
        try{
            message = ChatRoomMessage.createFromJsonString(intent.getStringExtra("message"));
